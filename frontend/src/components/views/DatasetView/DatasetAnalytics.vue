<template>
    ...
    <div class="font-semibold mx-2 text-lg laptop:text-xl desktop:text-2xl 4k:text-3xl underline mt-4">Analytics</div>   

    <div class="w-full text-sm laptop:text-lg desktop:text-xl 4k:text-xl">
        <div class="grid grid-cols-5  py-2 px-4 rounded border-2">
