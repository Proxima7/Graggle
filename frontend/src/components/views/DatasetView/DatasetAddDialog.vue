<template>
    ...
    <!-- Popup dialog -->
    <div class="fixed inset-0 z-50 flex items-center justify-center" v-if="showDialog">
                    ...
                    <div class="">
                        ...
                        <div class="border-b border-gray-900/10 mt-2 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-6">
                            <div class="sm:col-span-4">
                                <label for="text" class="block text-sm font-medium leading-6 text-gray-900">Dataset titel</label>
                                <div class="mt-0">
                                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    <input  required type="text" name="titel" id="titel"  v-model="titel" autocomplete="titel" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="meaningful titel for the dataset"/>
                                </div>
                                </div>
                            </div>

                            <div class="sm:col-span-4">
                                <label for="shortdesc" class="block text-sm font-medium leading-6 text-gray-900">Short description</label>
                                <div class="mt-0">
                                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    <input required type="shortdesc" name="shortdesc" id="shortdesc" v-model="shortdesc" autocomplete="titel" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="short description of the dataset"/>
                                </div>
                                </div>
                            </div>

                            <div class="col-span-full">
                                <label for="desc" class="block text-sm font-medium leading-6 text-gray-900">Detail description</label>
                                <div class="mt-0">
                                <textarea required id="desc" name="desc" v-model="desc" rows="3" class="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:py-1.5 sm:text-sm sm:leading-6" />
                                </div>
                                <p class="mt-3 text-sm leading-6 text-gray-600">Write a few sentences what the dataset is about.</p>
                            </div>

                            <div class="col-span-full ">
                                <label for="images" class="block text-sm font-medium leading-6 text-gray-900">Preview photo</label>
                            ...
                            <div class="col-span-full">
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div class="p-2">
                                        <label for="createdby" class="block text-sm font-medium leading-6 text-gray-900">Created by</label>
                                    </div>
                                    <div class="p-2">
                                        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                            <input required type="createdby" name="createdby" id="createdby" v-model="createdby" autocomplete="createdby" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="name or service"/>
                                        </div>
                                    </div>
                                </div>
                            </div>                          
                        ...
                        <div class="mt-2 flex items-center justify-end gap-x-6">
                            <button type="button" class="text-sm font-semibold leading-6 text-gray-900" @click="closeDialog">Cancel</button>
                            <button class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" @click="storeDB">Save</button>
                        </div>
