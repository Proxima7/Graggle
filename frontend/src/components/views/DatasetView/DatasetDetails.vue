<template>
    ...
    <div class="grid grid-cols-6 gap-2 grid-rows-auto border-2 shadow rounded p-2 mt-0">
        <!--
            Explorer + prev/next
        -->
        <div class="max-[1800px]:flex flex-wrap max-[1800px]:col-span-6 min-[1800px]:col-span-2 mt-4 text-sm laptop:text-lg desktop:text-xl 4k:text-2xl">
        ...
        <div class="max-[1800px]:col-span-6 min-[1800px]:col-span-4 mt-4 border-2 shadow rounded p-1 text-sm laptop:text-lg desktop:text-xl 4k:text-2xl">
        ...
        -->        
        <div class="max-[1800px]:col-span-6 min-[1800px]:col-span-2 flex flex-col  max-[1800px]:max-h-[330px] min-[1800px]:h-full text-sm laptop:text-lg desktop:text-xl 4k:text-2xl" >
            <div class="flex-1 border-2 shadow rounded p-4 max-[1800px]:max-h-[330px]">
                <div class="max-[1800px]:max-h-[330px]">
                    <p class="font-bold max-[1800px]:max-h-[35px]">JSON</p>
        ...
        <div class="max-[1800px]:col-span-6 min-[1800px]:col-span-4 border-2 shadow rounded text-sm laptop:text-lg desktop:text-xl 4k:text-2xl">
            <p class="font-bold p-2">IMAGE</p>
